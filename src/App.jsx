...
const data = {
  ...
  aboutSummary:
    "I specialize in developing functional, scalable systems and constantly seek out new methodologies and emergent practices to engineer robust, user-centric solutions to real-world challenges.",
